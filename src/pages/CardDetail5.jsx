...
const CardDetail5 = () => {
  ...
  const wissamImg = mode ? images.WISSAM_NASSAR.dark : images.WISSAM_NASSAR.light;
  const noohImg = mode ? images.NOOH_AL_SHAGHNOBI.dark : images.NOOH_AL_SHAGHNOBI.light;
  const salehImg = mode ? images.SALEH_ALJAFARAWI.dark : images.SALEH_ALJAFARAWI.light;
    ...
    <div className={`w-[98%] xl:w-[50%] xl:mx-auto md:mx-auto flex flex-col ${ mode ? 'text-custom-white' : 'text-custom-black'} z-50`} >
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col w-full text-center justify-center items-center gap-2' >
          ...
          <div className='flex' >
            ...
            <a href='https://www.tiktok.com/@salma.shawa?_t=8pl8wmCJP8A&_r=1' target="_blank" rel="noopener noreferrer" className='text-5xl' >
              <AiFillTikTok />
            </a>
          </div>
        </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col w-full text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.instagram.com/motaz_azaiza?igsh=aDFvZDg0Y2p4cmY0' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <AiFillInstagram />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.instagram.com/wizard_bisan1?igsh=MTFtczFlYjJvZzlsbA==' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <AiFillInstagram />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.instagram.com/hossam_shbat?igsh=MWs1aW56MmpoZXA1dQ==' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <AiFillInstagram />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.instagram.com/wissamgaza?igsh=ZnBoMWdmanI1NnVv' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <AiFillInstagram />
          </a>
        </div>
      </div>
