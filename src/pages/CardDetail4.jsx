...
import PhotoSpotify from '../assets/PhotoSpotify';
    ...
    <div className={`w-[98%] xl:w-[50%] xl:mx-auto md:mx-auto flex flex-col ${ mode ? 'text-custom-white' : 'text-custom-black'} z-50`} >
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://open.spotify.com/artist/1ATrNccUrhiYSQ3B08VQrz?si=ZlqMOt-bS2-p5fGZePsV-w' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaSpotify />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://open.spotify.com/artist/35Or8bOOKNt9UJKHcySKdP?si=9xX5RLKpR6Kib3TgN3RYgQ' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaSpotify />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <span className={DescriptionStyle} >
            - 4.741 Oyentes mensuales.
          </span>
          <a href='https://open.spotify.com/playlist/3vV7dd0tQdhUXRhst9Y4H2?si=9i555wutQ7Kc4NDa1z24Ug&pi=u-0xUNXZPrRP-j' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaSpotify />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[20vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex w-full flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://open.spotify.com/artist/7BbiOEvJs6qrSDp54s1EUB?si=gX-GU6XsR7Kk0oidck9rcA' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaSpotify />
          </a>
        </div>
      </div>
