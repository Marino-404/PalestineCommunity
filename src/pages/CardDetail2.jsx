...
import { SectionStyle, TitleStyle, DescriptionStyle, Stars } from './CardDetail1';
    ...
    <div className={`w-[98%] xl:w-[68%] xl:mx-auto md:mx-auto flex flex-col ${ mode ? 'text-[#ffffffc2]' : 'text-[#000000c2]'} z-50`} >
      ...
      <div className='xl:h-[24vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.filmin.es/serie/east-side' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaPlayCircle />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[24vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.filmin.es/pelicula/gaza-mon-amour' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaPlayCircle />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[24vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col text-center justify-center items-center gap-2' >
          ...
          <span className={DescriptionStyle} >
            Walaa, una chica adolescente criada en un campo de refugiados, que rompe todas las reglas al decidir convertirse en una de las pocas mujeres policías de las fuerzas de seguridad palestinas. 
          </span>
          <div className={Stars} >
            <FaStar />
            <FaStar />
          ...
          <a href='https://www.filmin.es/pelicula/lo-que-walaa-quiere' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaPlayCircle />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[24vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.filmin.es/corto/gaza' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaPlayCircle />
          </a>
        </div>
      </div>
      ...
      <div className='xl:h-[24vw] flex xl:flex-row flex-col' >
        ...
        <div className='flex flex-col text-center justify-center items-center gap-2' >
          ...
          <a href='https://www.filmin.es/pelicula/el-color-de-los-olivos' target="_blank" rel="noopener noreferrer" className='text-5xl' >
            <FaPlayCircle />
          </a>
        </div>
      </div>
