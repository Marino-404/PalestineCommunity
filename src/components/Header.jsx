...
const Header = () => {
  ...
  return (
    <header  className={`xl:fixed flex items-center justify-between w-full h-[7vh] xl:h-[6vh] z-50 ${mode ? "text-custom-white" : "text-custom-black"} animate-fade-down animate-duration-[1000ms]`}>
